public class Pokemon {
	...
	public Pokemon(int dexParam, String nameParam, int healthParam, int specialDefenseParam, int defenseParam,
			int attackParam, int specialAttackParam, int speedParam, Move[] movesParam, String type1Param,
			String type2Param, String statusParam,

			int attackModifierParam, int specialAttackModifierParam, int defenseModifierParam,
			int specialDefenseModifierParam, int speedModifierParam) {
...
//    int speedModifierParam
	public Pokemon applyModifiers(Pokemon target) {
		return new Pokemon(target.getDex(), target.getName(), target.getHealth(),
				target.getSpecialDefense()
						+ (int) (target.getSpecialDefenseModifier() * 0.5 * target.getSpecialDefense()),
				...
				target.getSpeed() + (int) (target.getSpeedModifier() * 0.5 * target.getSpeed()), target.getMoves(),
				target.getType1(), target.getType2(), target.getStatus(), target.getAttackModifier(),
				target.getSpecialAttackModifier(), target.getDefenseModifier(), target.getSpecialDefenseModifier(),
	...
	public String toString() {
		String answer = "\nDexNumber: " + dex + "\n" + "Name: " + name + "\n" + "Health: " + health + "\n"
				...
				+ " attack, " + defenseModifier + " defense, " + specialAttackModifier + " special attack, "
				+ specialDefenseModifier + " special defense modifier, " + speedModifier + " speed modifier" + "\n";
		return answer;
	}
}
